    ...
    public class CombatGetInShootingRangeGoal : CombatAIGoal {
        ...
        public override bool Run() {
            ...
            for (var i = 0; i < 100; i++) {
                ...
                target.y = pos.y;
                if (/*Vector3.Distance(Entity.transform.position, Entity.CombatManager.Player.transform.position) < Entity.Weapon.IdealRange &&*/ !Physics.Linecast(_playerPos, target)) {
